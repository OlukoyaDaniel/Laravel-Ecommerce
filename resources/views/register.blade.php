        ...
        @csrf
          <div class="full-name">
            <div class="form-group">
              ...
              <input name='first_name' class="" type="text" value="{{ old('first_name') }}" placeholder="Enter your first name" required autocomplete="name" autofocus>
              @error('first_name')
          ...
          <div class="form-group">
            ...
            <input name='confirm_password' type="password" value="{{ old('confirm_password') }}" placeholder="Confirm your password">
          </div>
          <div class="form-group">
